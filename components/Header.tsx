  ...
  return (
    <header className="relative z-20 mx-auto w-full max-w-6xl px-5 py-5 sm:py-6">
      <div className="flex items-center justify-between">
        ...
        <span className="hidden rounded-full border border-sky-400/40 bg-sky-400/10 px-3.5 py-1.5 text-xs font-medium uppercase tracking-[0.18em] text-sky-100 sm:inline-flex">
          Prototype STIC&apos;26
        </span>
      </div>
    </header>
