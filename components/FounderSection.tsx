        ...
        <div className="mt-4 flex flex-col items-center gap-5 sm:flex-row sm:items-start sm:gap-6">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="mt-3 text-sm leading-relaxed text-slate-200/85 sm:text-base">
              ...
              langue maternelle devienne un droit numérique — et non un
              privilège réservé aux locuteurs des langues officielles.
            </p>

            <div className="mt-4 flex flex-wrap items-center justify-center gap-2 sm:justify-start">
              <span className="rounded-full bg-white/5 px-3 py-1 text-[11px] uppercase tracking-wider text-slate-300">
                Candidature STIC&apos;26
              </span>
              <span className="rounded-full bg-white/5 px-3 py-1 text-[11px] uppercase tracking-wider text-slate-300">
                Voice-first · NLP · TTS
